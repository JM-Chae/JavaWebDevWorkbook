...
import com.example.boot.service.ReplyService;
...
public class ReplyController
  {
    ...
    @Operation(summary = "Replies POST", description = "Reply with POST")
    ...
    @Operation(summary = "Delete Reply", description = "DELETE 방식으로 특정 댓글을 삭제")
    @DeleteMapping("/{rno}")
